...
QT_MOC_LITERAL(1, 14, 12), // "update_table"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 18), // "on_btnSave_clicked"
QT_MOC_LITERAL(4, 47, 9), // "setTaskId"
QT_MOC_LITERAL(5, 57, 6) // "taskId"

    },
    "NewTaskDialog\0update_table\0\0"
    "on_btnSave_clicked\0setTaskId\0taskId"
};
...
void NewTaskDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setTaskId((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NewTaskDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NewTaskDialog::update_table)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NewTaskDialog::update_table()
{
